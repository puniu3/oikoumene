...
`;const b=(n,e)=>{const l=Number(e);if(!Number.isInteger(l)||l<0)throw new Error(`${n} は0以上の整数(受け取った値: ${e})`);return l},A=(n,e)=>{const l=Number(e);if(!Number.isFinite(l)||l<0||l>1)throw new Error(`${n} は 0〜1(受け取った値: ${e})`);return l};function R(n){const e=new URLSearchParams(n),l=[],t={},i={},p=e.get("aeRadius");p!==null&&(t.minorAlarmRadius=b("aeRadius",p),l.push(`半径${t.minorAlarmRadius}`));const o=e.get("aeRolls");o!==null&&(t.minorAlarmRolls=b("aeRolls",o),l.push(`攻囲${t.minorAlarmRolls}ロール`));const W=e.get("aeCapRolls");W!==null&&(t.minorCaptureRolls=b("aeCapRolls",W),l.push(`陥落${t.minorCaptureRolls}ロール`));const u=e.get("aeHit");if(u!==null)if(!u.includes(":"))i["*"]=A("aeHit",u),l.push(`当たり${i["*"]}`);else for(const s of u.split(",").filter(Boolean)){const[a,r]=s.split(":");if(!a||r===void 0)throw new Error(`aeHit の書式は persona:値 のカンマ並び(受け取った値: ${s})`);i[a]=A(`aeHit:${a}`,r),l.push(`${a}の当たり${i[a]}`)}return l.length?{label:l.join(" / "),patch:s=>{for(const[r,c]of Object.entries(t)){if(!(r in s.rules))throw new Error(`gamedata に rules.${r} が無い`);s.rules[r]=c}const a=s.minorAlarmHit;if(Object.keys(i).length&&!a)throw new Error("gamedata に minorAlarmHit が無い");for(const[r,c]of Object.entries(i)){if(r==="*"){for(const v of Object.keys(a))a[v]=c;continue}if(!(r in a))throw new Error(`minorAlarmHit に性格 ${r} が無い(${Object.keys(a).join("/")})`);a[r]=c}}}:null}function g(n,e){const l=R(e);if(!l)return{text:n,label:null};const t=JSON.parse(n);return l.patch(t),{text:JSON.stringify(t),label:l.label}}const y=3,S=[{id:"pottery",cost:6,vp:2,req:null},{id:"writing",cost:8,vp:2,req:"pottery",grants:"admin"},{id:"law",cost:12,vp:2,req:"writing",mod:{tileLimit:1}},{id:"bronze",cost:8,vp:2,req:null},{id:"iron",cost:14,vp:2,req:"bronze",mod:{combat:1}},{id:"wheel",cost:4,vp:2,req:null},{id:"riding",cost:6,vp:2,req:"wheel",mod:{halveTerrain:'"'}},{id:"trade",cost:10,vp:2,req:["coinage","wheel"],mod:{halveTerrain:"d"}},{id:"accounting",cost:24,vp:2,req:"trade"},{id:"education",cost:22,vp:2,req:"law"},{id:"medicine",cost:14,vp:2,req:["writing","trade"],mod:{popLimit:1}},{id:"biology",cost:28,vp:2,req:"medicine"},{id:"coinage",cost:10,vp:2,req:"bronze",grants:"mint"},{id:"compass",cost:16,vp:2,req:["iron","trade"]},{id:"civil",cost:18,vp:2,req:["law","coinage"],grants:"admin",mod:{tileLimit:1}},{id:"masonry",cost:6,vp:2,req:null,grants:"pyramid"},{id:"construction",cost:12,vp:2,req:"masonry"},{id:"feudalism",cost:24,vp:2,req:["iron","riding"],mod:{tileLimit:1}},{id:"nationalism",cost:32,vp:2,req:["feudalism","civil"],mod:{natTurns:y}},{id:"reclaim",cost:22,vp:2,req:"construction",mod:{tileLimit:1}},{id:"gunpowder",cost:40,vp:2,req:["feudalism","education"],mod:{combat:2}},{id:"steam",cost:36,vp:2,req:["gunpowder","construction"],mod:{fleetCombat:1}},{id:"steel",cost:48,vp:2,req:"iron"},{id:"railroad",cost:60,vp:2,req:["steel","steam"],mod:{claimAnywhere:!0,halveOwnLand:!0}},{id:"telegraph",cost:64,vp:2,req:"compass",grants:"admin"},{id:"industry",cost:72,vp:2,req:["accounting","steam"]},{id:"combustion",cost:96,vp:2,req:"industry",mod:{combat:3}},{id:"aviation",cost:110,vp:2,req:"combustion",mod:{siegeTurns:2}}];Object.fromEntries(S.map(n=>[n.id,n]));const B="fractal",w="random:first-game-v1",X=n=>n===w||n==="random"?B:n.startsWith("random:")?n.slice(7):null,P=n=>X(n)!==null;function H(n,e,l){let t=0,i=0,p=null;const o=[],W=(s,a,r)=>({appliedTurns:t,appliedDraftActions:i,roundStart:p,snapshots:o,bad:{at:s,kind:a,detail:r}});for(let s=0;s<e.turns.length;s++){const a=e.turns[s],r=n.world_hash();if(r!==a.baseHash)return W(s,"base",`turn ${a.turn}: expected base ${a.baseHash}, got ${r}`);const c=JSON.parse(n.resolve_turn(JSON.stringify(a.commits)));if(!c.ok)return W(s,"resolve",c.error??`turn ${a.turn} did not resolve`);if(c.hash!==a.resultHash)return W(s,"result",`turn ${a.turn}: expected ${a.resultHash}, got ${c.hash}`);t++,o.push(JSON.parse(n.snapshot(BigInt(a.turn))))}p=l();const u=e.current;if(!u)return{appliedTurns:t,appliedDraftActions:i,roundStart:p,snapshots:o,bad:null};if(u.seat!==n.local_seat())return W(e.turns.length,"invalid","pending draft belongs to another local seat");if(n.world_hash()!==u.baseHash||Number(n.turn())!==u.turn)return W(e.turns.length,"base",`pending draft T${u.turn}/${u.baseHash} does not match T${Number(n.turn())}/${n.world_hash()}`);for(let s=0;s<u.actions.length;s++){const a=u.actions[s],r=JSON.stringify(a),c=n.validate_action(r);if(c)return W(s,"invalid",c);const v=JSON.parse(n.apply_draft(r));if(v.error)return W(s,"invalid",v.error);if(!v.changed)return W(s,"ignored",`pending draft action ${s+1} was ignored`);i++}return{appliedTurns:t,appliedDraftActions:i,roundStart:p,snapshots:o,bad:null}}let m=null,F=null,d=1,C=0,f=null;async function T(n){if(m)throw new Error("Only one Game per page (one page = one match)");if(d=n.searchThreads??1,!Number.isInteger(d)||d<1||d>8)throw new Error("Search threads must be 1..8");if(d>1&&(!self.crossOriginIsolated||typeof SharedArrayBuffer>"u"))throw new Error("Parallel search needs HTTPS and cross-origin isolation");if(f||(f=d>1?await import("./notciv_wasm-8SF3NzCG.js"):await import("./notciv_wasm-BxIihrFY.js"),await f.default(),d>1&&(await f.initThreadPool(d),C=d)),d>1&&d>C)throw new Error("Create a new worker to enlarge its search pool");const e=f,l=g(J,n.search);e.feed(l.text);const t=e.bot_ids().split(`
`).filter(Boolean);if(!Number.isInteger(n.localSeat)||n.localSeat<0||n.localSeat>=16)throw new Error("invalid local seat");const i=new e.Game(BigInt(n.seed),n.mapId,n.players,n.localSeat);return P(n.mapId)&&(F=JSON.parse(i.map_def())),m=i,{botIds:t,genMapDef:F,aeLabel:l.label}}function h(n){const e=JSON.parse(n.draft_state_json());return F&&(e.genMapDef=F),e}function x(n){if(n.op==="init")return T(n.args);if(n.op==="benchReset")return m==null||m.free(),m=null,F=null,null;const e=m;if(!e)throw new Error("init has not run yet");switch(n.op){case"swapInitialSeats":{const l=e.swap_initial_seats(n.args.source);if(l)throw new Error(l);return null}case"setHandicap":return n.args.mult!==0&&e.set_handicap(n.args.mult,n.args.seats),null;case"debugPatch":return e.debug_patch(JSON.stringify(n.args.patch)),null;case"applyDraft":{const l=JSON.parse(e.apply_draft(JSON.stringify(n.args.action)));return{evs:l.events??[],changed:!!l.changed,error:l.error??null}}case"resetDraft":return e.reset_draft(),null;case"humanCommit":{const l=e.human_commit();return{commit:l?JSON.parse(l):null}}case"botCommit":{const{botId:l,seat:t,carry:i}=n.args,p=d>1&&l.startsWith("anytime-")?e.parallel_anytime_bot_commit(l,t,i,void 0,d):e.bot_commit(l,t,i);if(!p)return{commit:null,why:`bot "${n.args.botId}" or live seat ${n.args.seat} missing`,carry:"",stats:""};const o=JSON.parse(p);return{commit:o.commit,why:null,carry:typeof o.carry=="string"?o.carry:"",stats:typeof o.stats=="string"?o.stats:""}}case"benchAnytimeCommit":{const l=performance.now(),{botId:t,seat:i,carry:p,budget:o,threads:W=1}=n.args;if(!Number.isInteger(W)||W<1||W>Math.max(1,C))throw new Error("Requested search threads exceed this worker's pool");const u=C>0?e.parallel_anytime_bot_commit(t,i,p,o??void 0,W):o===null?e.bot_commit(t,i,p):e.bench_anytime_bot_commit(t,i,p,o),s=performance.now()-l;if(!u)return{commit:null,why:`No benchmark bot "${t}" or living seat ${i}`,carry:"",stats:"",ms:s};const a=JSON.parse(u);return{commit:a.commit,why:null,carry:typeof a.carry=="string"?a.carry:"",stats:typeof a.stats=="string"?a.stats:"",ms:s,parallel:a.parallel}}case"expandBeamSlice":{const l=e.expand_beam_slice(n.args.seat,JSON.stringify(n.args.lines),n.args.beamWidth);return JSON.parse(l)}case"benchStatus":return JSON.parse(e.bench_status());case"resolveTurn":{const l=JSON.parse(e.resolve_turn(JSON.stringify(n.args.commits)));return{ok:!!l.ok,error:l.error??null,evs:l.events??[],hash:l.hash??null,turn:l.turn??null}}case"validate":{const l=n.args.action;return{why:e.validate_action(typeof l=="string"?l:JSON.stringify(l))||null}}case"state":return h(e);case"view":return JSON.parse(e.view());case"mapDef":return JSON.parse(e.map_def());case"snapshot":return JSON.parse(e.snapshot(BigInt(n.args.turn)));case"replay":return H(e,n.args,()=>h(e));case"claimOptions":return JSON.parse(e.claim_options());case"placeOptions":return JSON.parse(e.place_options());case"helper":return JSON.parse(e.helper());case"decayField":return JSON.parse(e.decay_field(n.args.prov));case"fleetField":return JSON.parse(e.fleet_field(n.args.prov));case"fleetProjectionField":return JSON.parse(e.fleet_projection_field(n.args.seat));case"attackField":return JSON.parse(e.attack_field(n.args.seat));case"seaControl":return JSON.parse(e.sea_control(n.args.seat));case"worldHash":return e.world_hash()}}let M=Promise.resolve();self.onmessage=n=>{const e=n.data,l=t=>self.postMessage(t);M=M.then(async()=>{try{l({id:e.id,ok:!0,value:await x(e)})}catch(t){l({id:e.id,ok:!1,err:String(t)})}})};
